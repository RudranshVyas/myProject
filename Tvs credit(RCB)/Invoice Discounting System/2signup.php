  ...
  <body class="text-center">
      <div class="container">
            <form method="post" class="form-signin">
              ...
              <h2>Apply to:</h2>
              <input type="Checkbox" name="axis" value="yes">AXIS(0.75pm)
<input type="Checkbox" name="hdfc" value="yes">HDFC(0.80 pm)
<input type="Checkbox" name="tvs" value="yes">TVS(0.70 pm)
